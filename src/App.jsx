...
const CreatePost = lazy(() => import("./Components/CreatePost/CreatePost.jsx"));
const StockScreenersContent = lazy(() => import("./Components/Home/components/StockScreenersContent.jsx"));
const LearnPageContent = lazy(() => import("./Components/Home/components/LearnPageContent.jsx"));
const NewsPageContent = lazy(() => import("./Components/Home/components/NewsPageContent.jsx"));
...
function Main() {
  ...
  return (
    <TransitionGroup component={null}>
      ...
      >
        <Container ref={nodeRefs.current[location.key]} className="page-container">
